...
const LoginForm = () => {
  ...
  const { storeToken, authenticateUser, user, isLoggedIn } =
  ...
  console.log("Logged In after log in:", isLoggedIn);
        ...
        <div className="columns">
          <div className="column is-half is-offset-one-quarter">
            ...
            <p className="mb-3">
              ...
              <Link to={"/auth/request-password-reset"}>here</Link>
            </p>
            <Link to={"/auth/signup"} className="login-signup-buttons">
              {" "}
              Sign Up
            </Link>
          </div>
